...
public class MyMBTI extends JFrame {
    ...
    public MyMBTI(Consumer<String> onSelected) {
        super("나의 MBTI 찾기");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() ->
            new MyMBTI(selected -> System.out.println("선택 결과: " + selected))
                .setVisible(true)
        );
    }
}
